...
ruleTester.run('affixed-ids', rule, {
  valid: [
    ...
    },
    {
      ...
      options: [
        {ignoredIdentifiers: [{regex: {pattern: '_ignored_', flags: 'i'}}]},
      ],
    },
    ...
    },
    {
      ...
      options: [
        {allowedSuffixes: [{regex: {pattern: '_any[a-zA-Z]*'}}, '_opt']},
      ],
    },
  ...
  invalid: [
    /* Base style */
    {
      ...
      errors: [
        {
          message: "Identifier 'snake_id' does not conform.",
          type: 'Identifier'},
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'Upper' does not conform.",
          type: 'Identifier',
        },
      ],
    },
    ...
    /* Exceptions */
    {
      ...
      errors: [
        {
          message: "Identifier 'snake_id_' does not conform.",
          type: 'Identifier'},
      ],
    },
    ...
    /* Prefixes */
    {
      ...
      errors: [
        {
          message: "Identifier 'xopt_id' does not conform.",
          type: 'Identifier'},
      ],
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'nanyPrefix_id' does not conform.",
          type: 'Identifier'},
      ],
    },
    ...
    /* Suffixes */
    {
      ...
      errors: [
        {
          message: "Identifier 'id_optx' does not conform.",
          type: 'Identifier'},
      ],
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'id_anySuffix2' does not conform.",
          type: 'Identifier'},
      ],
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'op_t' does not conform.",
          type: 'Identifier',
        },
      ],
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'a_3' does not conform.",
          type: 'Identifier'},
      ],
    },
    ...
    /* Exceptions */
    {
      ...
      errors: [
        {
          message: "Identifier 'any_iGnOrEd_id' does not conform.",
          type: 'Identifier',
        },
      ],
    },
    ...
    /* Leading and trailing underscores */
    {
      ...
      errors: [
        {
          message: "Identifier '_id' does not conform.",
          type: 'Identifier',
        },
      ],
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'id_' does not conform.",
          type: 'Identifier',
        },
      ],
    },
    ...
    /* Examples */
    {
      ...
      errors: [
        {
          message: "Identifier 'param_opt' does not conform.",
          type: 'Identifier',
        },
        {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Identifier 'rate_kHz' does not conform.",
          type: 'Identifier',
        },
        {
